...
6 + 9 + 2 + 8 + 7 you get 32. Then there are 17
letters in the string. 32 / 17 = 1.882, and the final answer 
...
export function NumberSearch(str) {
  let numArr = str.replace(/[^0-9]/g, '').split('');
  let letterArr = str.replace(/[^a-zA-Z]/g, '').split('');
  let sum = 0;
